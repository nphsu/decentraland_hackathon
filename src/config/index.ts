namespace Position {
  ...
  export const initBox01 = new Vector3(-8.5, 3, 5)
  export const initBox02 = new Vector3(-8.5, 3, 11)
  export const initBox03 = new Vector3(-8.5, 9, 5)
  export const initBox04 = new Vector3(-8.5, 9, 11)
  export const initBox05 = new Vector3(-2.5, 9, 5)
  export const initBox06 = new Vector3(-2.5, 9, 11)
  // export const initBox07 = new Vector3(-2, 3, 5)
  export const initBox07 = new Vector3(-2.5, 3, 5)
  export const initBox08 = new Vector3(-2.5, 3, 11)
  export const initBox09 = new Vector3(3.5, 3, 5)
  export const initBox10 = new Vector3(3.5, 3, 11)
  export const initBox11 = new Vector3(3.5, 9, 5)
  export const initBox12 = new Vector3(3.5, 9, 11)
  export const initBox13 = new Vector3(3.5, 9, -1)

  export const initBox51 = new Vector3(3.5, 16, 4.5)
  export const initBox52 = new Vector3(3.5, 16, 11.5)
  export const initBox53 = new Vector3(3.5, 16, 4.5)
  export const initBox54 = new Vector3(3.5, 16, 11.5)
  export const initBox55 = new Vector3(3.5, 16, 4.5)
  export const initBox56 = new Vector3(9.5, 3, 11.5)
  export const initBox57 = new Vector3(9.5, 3, 4.5)
  export const initBox58 = new Vector3(9.5, 9, 11.5)
  export const initBox59 = new Vector3(9.5, 9, 4.5)
  export const initBox60 = new Vector3(9.5, 15, 11.5)
  export const initBox61 = new Vector3(9.5, 15, 11.5)
  export const initBox62 = new Vector3(15.5, 12, 11)
  export const initBox63 = new Vector3(15.5, 12, 5)
